...
On a personal note, I want to thank my family who offered me the confort and condition to study in Germany in the past 4 years. Many thanks to the friends I get to know here, whom I know would always stand by me and help me out.
...
\cite{shi2025} report 72.7\,\% success on a diverse-object benchmark. They used a Robotiq 2F-85 gripper and objects up to $\sim$1\,kg. In that paper a process is counted as success, when the gripper could grasp the object up and hand it to the operator shortly after. It only checks whether the gripper closes stably. The benchmark excludes downstream task success such as transport and placement.
...
(3)~the success criterion encompasses the full pick-transport-place sequence, whereas the benchmark measures isolated grasp success.

Each factor independently would depress the achievable success rate relative to the benchmark setting. That the Final condition achieves 77.1\,\% despite these three compounding disadvantages indicates that the centroid-based constraints and custom fingertip are sufficient to maintain above-benchmark performance even under harder deployment conditions.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\linewidth]{F3-collision-trajectory.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.6\linewidth]{F3-alart-joint-limit.jpg}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\linewidth]{frontal-overview-1.png}
