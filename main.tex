...
\begin{figure}[htbp]
  ...
  \fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}
    \textit{[Figure 3.2: Grip zone on the angle grinder point cloud. Inner radius $d_{\min}$ = 0.01\,m, outer radius $d_{\max}$ = 0.025\,m, centred on geometric centroid proxy $\hat{c}$.]}
    \vspace{3cm}}}
...
\begin{figure}[htbp]
  \centering
  \fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}
    \textit{[Figure 3.3: Axis alignment constraint]}
    \vspace{3cm}}}
...
\begin{figure}[htbp]
  \centering
  \fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}
    \textit{[Figure 4.1: Experimental Setup]}
    \vspace{3cm}}}
...
\begin{figure}[htbp]
  \centering
  \fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}
    \textit{[Failure mode F2: No valid candidate after filtering.]}
    \vspace{3cm}}}
...
\begin{figure}[htbp]
  \centering
  \fbox{\parbox{0.8\textwidth}{\centering\vspace{3cm}
    \textit{[Failure mode F3: Kinematic infeasibility.]}
    \vspace{3cm}}}
